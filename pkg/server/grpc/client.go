...
import (
	...
	"github.com/rfw141/anr/pkg/server/grpc/resolver/discovery"
	"time"
	...
	// init resolver
	_ "github.com/rfw141/anr/pkg/server/grpc/resolver/direct"
)
...
func WithDiscovery(d internal.Discovery) ClientOption {
	return func(o *clientOptions) {
		o.discovery = d
	}
}
